...
check for "hex" ls -la /home/vscode/.mix/archives | grep hex
check for "phx_new" ls -la /home/vscode/.mix/archives | grep phx_new
check for "rebar" ls -la /home/vscode/.mix/elixir/1-16 | grep rebar3
